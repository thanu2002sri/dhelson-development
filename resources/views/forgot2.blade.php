                    ...
                    @else
                        ...
                        <div class="block animation-fadeInQuickInv">
                            ...
                            <div class="block-title">
                                <h4>Hello, Name of the usser</h4>
                            </div>
                            <p>Please answer your question to reset your password</p>
                            <!-- END Login Title -->
                            ...
                            <!-- Login Form -->
                            <form id="form-forgotpassword" action="{{ route('forgot.password') }}" method="post" class="form-horizontal">
                                @csrf
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="forgot-text-input">Your question is </label>
                                    <div class="col-md-6">
                                    <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Answer">
                                    <span class="help-block">This answer is case sensitive, Please make sure your entering correct answer.</span>
                                    </div>
                                    </div>
