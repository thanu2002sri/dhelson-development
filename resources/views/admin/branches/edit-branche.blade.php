    ...
    <div id="page-content">
            ...
            <!-- END Page Header -->
             ...
             <div class="block full">
                <form action="{{ url('/admin/'.$branch->id.'/update-branch') }}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                    @csrf
                    <div class="block-title text-center">
                        <h2> Dhelson Express {{ $title }}  </h2>    
                        <div class="pull-right" style="padding-right: 40px;padding-top:2px;">
                            <select id="distr-security-question" name="status" value="{{ $branch->status }}" autocomplete="status" autofocus class="select-select2 @error('status') is-invalid @enderror" style="width: 100%;" data-placeholder="Select Status" required>
                                <option value="">Select Status</option><!-- Required for data-placeholder attribute to work with Select2 plugin -->

                                    @if(!empty($branch->status) && $branch->status!="0")
                                    ...
                                    <div class="col-sm-5" style=" margin-top: 12px; ">
                                            <select id="distr-security-question" name="agent_id" value="{{ old('agent_id') }}" autocomplete="agent_id" autofocus class="form-control select-select2 @error('agent_id') is-invalid @enderror" style="width: 100%;" data-placeholder="Select Agent" required>
                                                ...
                                                @foreach($agents as $agent)
                                                    @if(!empty($agent->id) && $agent->id==$branch->agent_id)
                                                        <option selected="selected" value="{{ $agent->id }}">{{ $agent->phone }} - ( {{ $agent->name}} )</option>
                                                    @else
                                    ...
                                    <div class="col-sm-5" style=" margin-top: 12px; ">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-university"></i></span>
                                                <input type="text" name="name" value="{{ $branch->name }}" autocomplete="name" autofocus class="form-control @error('name') is-invalid @enderror" placeholder="Enter Agency Name" required>
                                        </div>
                                        @error('name')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5" style=" margin-top: 12px; ">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fas fa-envelope"></i></span>
                                                <input type="email" name="email" value="{{ $branch->email }}" autocomplete="email" autofocus class="form-control @error('email') is-invalid @enderror" placeholder="Enter Agency Email" required>
                                        </div>
                                        @error('email')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-sm-5" style=" margin-top: 12px; ">
                                        <div class="input-group">
                                            ...
                                            <input minlength="10" maxlength="10" pattern="[0-9]*" type="text" name="phone" value="{{ $branch->phone }}" autocomplete="phone" autofocus class="form-control @error('phone') is-invalid @enderror" placeholder="Enter Agency Phone Number" required>
                                        </div>
                                        @error('phone')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 form-field-margin">
                                    <textarea id="address" autofocus value="{{ $branch->address }}" class="form-control @error('address') is-invalid @enderror" placeholder="Enter Agency Address" required name="address" rows="4">{{ $branch->address }}</textarea>
                                    @error('address')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-5" style=" margin-top: 12px; ">
                                            <input id="pincode" minlength="6" maxlength="6" pattern="[0-9]*" type="text" name="pincode" value="{{ $branch->pincode }}" autocomplete="pincode" autofocus class="form-control @error('pincode') is-invalid @enderror" placeholder="Enter Agency Pincode" required>
                                            @error('pincode')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-5" style=" margin-top: 12px; ">
                                        <input id="city" type="text" name="city" value="{{ $branch->city }}" autocomplete="city" autofocus class="form-control @error('city') is-invalid @enderror" placeholder="Enter Agency City" required>
                                        @error('city')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-5" style=" margin-top: 12px; ">
                                            ...
                                            <input id="state" type="text" name="state" value="{{ $branch->state }}" autocomplete="state" autofocus class="form-control @error('state') is-invalid @enderror" placeholder="Enter Agency State" required>
                                            @error('state')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-5" style=" margin-top: 12px; ">
                                        ...
                                        <input id="country" type="text" name="country" value="{{ $branch->country }}" autocomplete="country" autofocus class="form-control @error('country') is-invalid @enderror" placeholder="Enter Agency Country" required>
                                        @error('country')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5" style=" margin-top: 12px; ">
                                        ...
                                        <input id="latitude" type="text" name="lattitude" value="{{ $branch->lattitude }}" autocomplete="lattitude" autofocus class="form-control @error('lattitude') is-invalid @enderror" placeholder="Enter Agency Latitude" required>
                                        @error('lattitude')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-sm-5" style=" margin-top: 12px; ">
                                    ...
                                    <input id="longtitude" type="text" name="logtitude" value="{{ $branch->logtitude }}" autocomplete="logtitude" autofocus class="form-control @error('logtitude') is-invalid @enderror" placeholder="Enter Agency Longtitude" required>
                                    @error('logtitude')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
