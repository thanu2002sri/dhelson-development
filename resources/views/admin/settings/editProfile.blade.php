        ...
        <!-- END Page Header -->
         ...
         <div class="col-md-6">
                <div class="block">
                        ...
                        <br>
                            <form action="{{ route('admin-reset-password') }}" method="post" class="form-horizontal form-bordered">
         ...
         {{-- <div class="col-md-6">
                <div class="block">
                        ...
                        <br>
                            <form action="{{ route('admin-reset-pin') }}" method="post" class="form-horizontal form-bordered">
                                <div class="form-group">
