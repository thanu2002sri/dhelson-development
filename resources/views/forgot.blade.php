            ...
            <div id="login-container">
                ...
                @if (Route::has('login'))
                    ...
                    <div class="block animation-fadeInQuickInv">
                            ...
                            <!-- Login Form -->
                            <form id="form-login" action="{{ route('forgot.password') }}" method="post" class="form-horizontal">
                                @csrf
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <input id="email" type="email" class="form-control " name="email" value="" placeholder="Enter email" required autocomplete="email" autofocus>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <input id="password" type="password" class="form-control is-invalid " name="password"  placeholder="Enter password" autocomplete="current-password">
