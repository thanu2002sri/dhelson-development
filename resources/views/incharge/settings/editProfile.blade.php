        ...
        <!-- END Page Header -->
         ...
         <div class="col-md-6">
                <div class="block">
                        ...
                        <br>
                            <form action="{{ route('distributor-reset-password') }}" method="post" class="form-horizontal form-bordered">
         ...
         <div class="col-md-6">
                <div class="block">
                        <div class="block-title text-center">
                            ...
                            <h2>Reset Trasaction Pin</h2>
                        </div>
                        <br>
                            <form action="{{ route('distributor-reset-pin') }}" method="post" class="form-horizontal form-bordered">
                                <div class="form-group">
