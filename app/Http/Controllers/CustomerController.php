...
class CustomerController extends Controller
{
    ...
    {
        $data['title'] = 'Add User';
        return view('customer.users.addUser', $data);
    }
    ...
    public function manageUsers()
    {
        ...
        return view('customer.users.manageUsers', $data);
    }
    ...
    public function editUser($id)
    {
        ...
        if($users){
            ...
            return view('customer.users.editUser', $data);
        }
        else{
            return redirect('/customer/manage-users')->with('error', 'Invalid User!');
        }
    ...
    public function deleteUser($id)
    {
        ...
        $user->delete();
        return redirect('/customer/manage-users')->with('success', 'User Deleted Successfully!');
    }
    ...
    public function editProfile()
    {
        ...
        return view('customer.settings.editProfile', $data);
    }
    ...
    public function resetPassword(Request $request)
    {
        ...
        if (Hash::check($data['old_password'], $password->password)) { 
            ...
            return redirect('/customer/dashboard')->with('success', 'Password Successfully updated!');
        }
        else{
            return redirect('/customer/edit-profile')->with('error', 'Invalid old password!');
        }
        return $request->all();
    }
    ...
    public function resetPin(Request $request)
    {
        ...
        if (Hash::check($data['old_pin'], $transaction_pin->transaction_pin)) { 
            ...
            User::where('id', Auth::user()->id)->update($newPassword);
            return redirect('/customer/dashboard')->with('success', 'Pin Number Successfully updated!');
        }
        else{
            return redirect('/customer/edit-profile')->with('error', 'Invalid old pin number!');
        }
        return $request->all();
    }
}
