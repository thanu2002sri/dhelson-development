...
class GuardController extends Controller
{
    ...
    {
        $data['title'] = 'Guard Dashboard';
        return view('guard.home', $data);
    }
    ...
    {
        $data['title'] = 'Add User';
        return view('guard.users.addUser', $data);
    }
        ...
        if($user) {
            ...
            if($comission->count() >= 1){
                if($comission->registration_comission >= 1)
                {
                    ...
                    return redirect('/guard/manage-users')->with('success', 'User Successfully Created!');
                }   
    ...
    public function manageUsers()
    {
        ...
        return view('guard.users.manageUsers', $data);
    }
    ...
    public function editUser($id)
    {
        ...
        if($users){
            ...
            return view('guard.users.editUser', $data);
        }
        else{
            return redirect('/guard/manage-users')->with('error', 'Invalid User!');
        }
    ...
    public function updateUser(Request $request)
    {
        ...
        if($userDetails) {
            ...
            return redirect('/guard/manage-users')->with('success', 'User Successfully Updated!');
        }
        return $request->all();
    }
    ...
    public function deleteUser($id)
    {
        ...
        $user->delete();
        return redirect('/guard/manage-users')->with('success', 'User Deleted Successfully!');
    }
    ...
    public function editProfile()
    {
        ...
        return view('guard.settings.editProfile', $data);
    }
    ...
    public function resetPassword(Request $request)
    {
        ...
        if (Hash::check($data['old_password'], $password->password)) { 
            ...
            return redirect('/guard/dashboard')->with('success', 'Password Successfully updated!');
        }
        else{
            return redirect('/guard/edit-profile')->with('error', 'Invalid old password!');
        }
        return $request->all();
    }
    ...
    public function resetPin(Request $request)
    {
        ...
        if (Hash::check($data['old_pin'], $transaction_pin->transaction_pin)) { 
            ...
            User::where('id', Auth::user()->id)->update($newPassword);
            return redirect('/guard/dashboard')->with('success', 'Pin Number Successfully updated!');
        }
        else{
            return redirect('/guard/edit-profile')->with('error', 'Invalid old pin number!');
        }
        return $request->all();
    }
}
