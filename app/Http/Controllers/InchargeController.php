...
class InchargeController extends Controller
{
    ...
    {   
        $this->middleware('incharge');
    }

    public function index()
    {
        $data['title'] = 'Incharge Dashboard';
        return view('incharge.home', $data);
    }
    ...
    {
        $data['title'] = 'Add User';
        return view('incharge.users.addUser', $data);
    }
    ...
    public function manageUsers()
    {
        ...
        return view('incharge.users.manageUsers', $data);
    }
    ...
    public function editUser($id)
    {
        ...
        if($users){
            ...
            return view('incharge.users.editUser', $data);
        }
        else{
            return redirect('/incharge/manage-users')->with('error', 'Invalid User!');
        }
    ...
    public function deleteUser($id)
    {
        ...
        $user->delete();
        return redirect('/incharge/manage-users')->with('success', 'User Deleted Successfully!');
    }
    ...
    public function editProfile()
    {
        ...
        return view('incharge.settings.editProfile', $data);
    }
    ...
    public function resetPassword(Request $request)
    {
        ...
        if (Hash::check($data['old_password'], $password->password)) { 
            ...
            return redirect('/incharge/dashboard')->with('success', 'Password Successfully updated!');
        }
        else{
            return redirect('/incharge/edit-profile')->with('error', 'Invalid old password!');
        }
        return $request->all();
    }
    ...
    public function resetPin(Request $request)
    {
        ...
        if (Hash::check($data['old_pin'], $transaction_pin->transaction_pin)) { 
            ...
            User::where('id', Auth::user()->id)->update($newPassword);
            return redirect('/incharge/dashboard')->with('success', 'Pin Number Successfully updated!');
        }
        else{
            return redirect('/incharge/edit-profile')->with('error', 'Invalid old pin number!');
        }
        return $request->all();
    }
}
