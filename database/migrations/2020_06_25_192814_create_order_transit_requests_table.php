...
class CreateOrderTransitRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('order_transit_requests', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('order_transit_requests');
    }
}
